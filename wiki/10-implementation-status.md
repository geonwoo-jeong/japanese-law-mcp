...
- [SOT-MODEL-019](../sot/20-model/19-law-update.md) と [SOT-IF-034](../sot/40-interfaces/34-law-update-list-capability.md) に従う、不変な `LawUpdate`、一日単位の型付き `law.update.list@1` 入力・完全一覧・能力別ポート。プロバイダー binding は次の実装単位とする
