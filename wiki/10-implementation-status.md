...
- [SOT-IF-040](../sot/40-interfaces/40-judicial-cases-pack-activation.md) の公開面を含む一括構成、および [SOT-IF-047](../sot/40-interfaces/47-mcp-search-judicial-cases.md) と [SOT-IF-048](../sot/40-interfaces/48-mcp-get-judicial-case.md) の二つの MCP ツールと composition root への公開接続は未実装である。
