...
| 4.2 | `SOT-ENG-026` | `legal-query-corpus-v2-development-assertions`、`legal-query-corpus-v2-holdout-coverage`、`legal-query-corpus-v2-leakage-digests`、`legal-query-corpus-derived-observation-population`、`legal-query-corpus-immutable-version` |
| 4.3 | `SOT-ENG-024` | `next-profile-set-development-only-calibration` |
| 4.4 | `SOT-ENG-038` | `candidate-evaluation-closed-artifacts`、`candidate-evaluation-request-identity`、`candidate-evaluation-candidate-content-identity`、`candidate-evaluation-referenced-file-bounds`、`candidate-evaluation-review-attestation`、`candidate-evaluation-review-content-binding`、`candidate-evaluation-evaluator-version-match`、`candidate-evaluation-corpus-admissibility`、`candidate-evaluation-build-context-isolation`、`candidate-evaluation-current-single-target`、`candidate-evaluation-production-unreachable`、`candidate-evaluation-ci-authority`、`candidate-evaluation-consumed-digest-preflight` |
