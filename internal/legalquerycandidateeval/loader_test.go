...
func prepareCandidateEvaluationFixture(t *testing.T, root string) EvaluationRequest {
	...
	writeCandidateFixture(t, root, filepath.Join(base, "schema-v4.json"), CanonicalSchemaV4())
	writeCandidateFixture(t, root, filepath.Join(base, "schema-v5.json"), CanonicalSchemaV5())
	manifest := manifestWithID(t)
